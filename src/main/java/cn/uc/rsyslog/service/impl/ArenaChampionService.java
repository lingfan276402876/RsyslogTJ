...
public class ArenaChampionService  implements ExcuteLogService{
	String sql = null;
	@Override
	 ...
	 * @param uid
	 */
	public static String getArenaChampion(String uid) {
		Jedis jedis = null;
		boolean broken = false;
	...
	{
		String fightKey = "RSYSLOG#FIGHT#ARENACHAMPION#"+uid;
		return fightKey;
	}
}
