...
public class GainPropService implements ExcuteLogService{
	String sql = null;
	@Override
	 ...
	 * 
	 * @param uid
	 * @param count 漂浮物最多的数量
	 */
	public static String getGainProp(String uid,int count) {
		Jedis jedis = null;
		boolean broken = false;
	...
	{
		String fightKey = "RSYSLOG#FIGHT#GAINPROP#"+uid;
		return fightKey;
	}
}
